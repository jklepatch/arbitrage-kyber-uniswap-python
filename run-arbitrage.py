...
signed_tx1 = web3.eth.account.signTransaction(tx1, OWNER_PRIVATE_KEY)
tx1_hash = web3.eth.sendRawTransaction(signed_tx1.rawTransaction)
print(tx1_hash)

tx2 = arbitrage.functions
...
signed_tx2 = web3.eth.account.signTransaction(tx2, OWNER_PRIVATE_KEY)
